...
import { Button, EmptyState, Field, Modal, TwoPane } from "../../shared/ui";
import {
          ...
          <main className="brainstorm-chat">
              ...
              {messages.map((message) => (
                ...
                >
                  ...
                  {message.role === "assistant" ? (
                    <BrainstormMarkdown content={message.content} />
                  ) : (
            ...
            >
              ...
              <Button
                ...
                type="submit"
                busy={isSending}
                disabled={!contextReady || !draft.trim()}
              >
...
function BrainstormMarkdown({ content }: { content: string }) {
